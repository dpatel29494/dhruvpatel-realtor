...
const AboutMe = () => {
  return (
    <section id="AboutMe" className="py-24 bg-gradient-to-b from-background via-secondary/20 to-background relative overflow-hidden">
      {/* Decorative elements */}
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            <h2 className="font-sans text-3xl md:text-4xl font-bold mb-6">
              ...
              <span className="block text-foreground mt-2">Your Trusted Real Estate Partner</span>
            </h2>
